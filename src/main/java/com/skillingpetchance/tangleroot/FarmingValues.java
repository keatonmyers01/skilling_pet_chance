...
public class FarmingValues {
    ...
    public static Map<Integer, String> getStateToPlantType(){
        return Map.<Integer, String>ofEntries(
                ...
                Map.entry(-4, "Fruit"), Map.entry(-5, "Fruit"), Map.entry(-6, "Fruit"),
                Map.entry(8033, "Fruit"), Map.entry(7979, "Fruit"), Map.entry(8118, "Fruit"),
                Map.entry(8091, "Fruit"), Map.entry(34917, "Fruit"), Map.entry(34021, "Fruit"),
                Map.entry(33704, "Fruit"), Map.entry(30493, "giant seaweed"), Map.entry(8326, "mushroom"),
